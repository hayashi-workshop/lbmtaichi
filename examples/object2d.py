...
obstacle = ObstacleManager(center_list=[nd[0] * 0.25, (nd[1]-1)/2], radius=radius, nd=nd)
...
step, step_end = 0, 300000 # |--- run your simulation ---> #
...
ti.tools.imwrite(renderer.img_buffer.to_numpy(), f"img/object2d.png")